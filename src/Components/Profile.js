      ...
      <div className="card mb-3">
        ...
        <div className="card-body">
          ...
          <ul className="list-unstyled mb-0">
            <li className="mb-1"><span data-feather="home" className="feather-sm me-1" /> Lives in <a href="#">San Francisco, SA</a></li>
            <li className="mb-1"><span data-feather="briefcase" className="feather-sm me-1" /> Works at <a href="#">GitHub</a></li>
            <li className="mb-1"><span data-feather="map-pin" className="feather-sm me-1" /> From <a href="#">Boston</a></li>
          </ul>
        </div>
        <hr className="my-0" />
        <div className="card-body">
        ...
        <div className="card-body h-100">
          ...
          <div className="d-flex align-items-start">
            ...
            <div className="flex-grow-1">
              ...
              <a href="#" className="btn btn-sm btn-danger mt-1"><i className="feather-sm" data-feather="heart" /> Like</a>
            </div>
          </div>
          <hr />
          <div className="d-flex align-items-start">

    ...
    <div className="row">
      <div className="col-12 col-lg-6">
        ...
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-primary">This line of text contains the text-primary class.</p>
            <p className="text-secondary">This line of text contains the text-secondary class.</p>
            <p className="text-success">This line of text contains the text-success class.</p>
            <p className="text-danger">This line of text contains the text-danger class.</p>
            <p className="text-warning">This line of text contains the text-warning class.</p>
            <p className="text-info">This line of text contains the text-info class.</p>
          </div>
        </div>
      </div>
      <div className="col-12 col-lg-6">
